...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           pet_label_unformatted = in_files[idx].split("_") 
           for index in range(len(pet_label_unformatted) - 1):
                pet_label += pet_label_unformatted[index].lower() + " "
